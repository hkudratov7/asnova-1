...
BOT_TOKEN = '6058913994:AAHUeeaEYbHzSH2FiwiVVPi7SXhELCe6ubA'      # Токен бота

CODE_ACCESS = 'TEST'    # код по которому можно будет давать доступ в итоге код получится TESTГОД-МЕСЯЦ-ЧИСЛО (TEST2020-01-01)

BOT_LOGIN = ' Djdjdjdjdjrhrbot'          # login бота, например: telegram_bot

ADMIN_ID = 5346039364       # id админа
